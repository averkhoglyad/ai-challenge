...
interface ConfigPort {
     ...
     *
     * @return [AppConfig] с заполненными [LlmConfig][io.averkhogliad.ai.challenge.week3.cli.domain.config.LlmConfig]
     *         и [TaskExecutionConfig][io.averkhogliad.ai.challenge.week3.cli.domain.config.TaskExecutionConfig]
