...
class MCPRenderer {
    ...
    private fun transportLabel(config: MCPServerConfig): String = when (config.transport) {
        is io.averkhogliad.ai.challenge.week3.cli.domain.model.MCPTransport.Stdio -> "Stdio"
        is io.averkhogliad.ai.challenge.week3.cli.domain.model.MCPTransport.StreamableHttp -> "HTTP"
    }
