...
interface CliRenderer {
    ...
    fun renderProfileList(profiles: List<io.averkhogliad.ai.challenge.week3.cli.domain.model.Profile>)
    fun renderProfileDetail(profile: io.averkhogliad.ai.challenge.week3.cli.domain.model.Profile)
    ...
    fun renderFsmState(state: io.averkhogliad.ai.challenge.week3.cli.domain.model.CommandState)

    // Debug mode pause after step execution
    fun waitForEnter()

    // FSM state command rendering (:state)
    fun renderFsmStateInfo(state: io.averkhogliad.ai.challenge.week3.cli.domain.model.CommandState)
    ...
    fun renderInvariantList(invariants: List<io.averkhogliad.ai.challenge.week3.cli.domain.model.Invariant>)
    fun renderInvariantAdded(invariant: io.averkhogliad.ai.challenge.week3.cli.domain.model.Invariant)
    ...
    fun renderStateMap(stateMap: io.averkhogliad.ai.challenge.week3.cli.domain.model.StateMap)
    ...
    fun renderAvailableTransitions(transitions: List<io.averkhogliad.ai.challenge.week3.cli.domain.model.Transition>)
