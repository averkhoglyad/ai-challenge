...
class MemoryIT : FreeSpec({
    ...
    "should handle complete memory lifecycle" - {
        runTest {
            ...
            taskListSession.messages.isEmpty() shouldBe true
            ...
            savedSession.messages.size shouldBe 2
            ...
            backToTaskList.messages.size shouldBe 2
            ...
            taskDetailAfterClear.messages.size shouldBe 2
    ...
    "should persist messages across service restarts" - {
        runTest {
            ...
            restoredSession.messages.size shouldBe 2
