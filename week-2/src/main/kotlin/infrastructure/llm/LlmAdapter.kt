...
import io.averkhogliad.ai.challenge.week2.domain.model.DomainFunctionCall
...
import io.averkhogliad.ai.challenge.week2.domain.service.ChatMessage as DomainChatMessage
...
class LlmAdapter(
    ...
    /** Маппинг infrastructure [ToolCall] → domain [DomainToolCall]. */
