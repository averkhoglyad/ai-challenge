...
interface ConfigPort {
     ...
     *
     * @return [AppConfig] с заполненными [LlmConfig][io.averkhogliad.ai.challenge.week2.domain.config.LlmConfig]
     *         и [TaskExecutionConfig][io.averkhogliad.ai.challenge.week2.domain.config.TaskExecutionConfig]
