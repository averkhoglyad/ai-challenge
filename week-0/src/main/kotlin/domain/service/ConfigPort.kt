...
import io.averkhogliad.ai.challenge.week0.domain.config.AppConfig
...
interface ConfigPort {
     ...
     *
     * @return [AppConfig] с заполненными [LlmConfig][io.averkhogliad.ai.challenge.week0.domain.config.LlmConfig]
     *         и [TaskExecutionConfig][io.averkhogliad.ai.challenge.week0.domain.config.TaskExecutionConfig]
