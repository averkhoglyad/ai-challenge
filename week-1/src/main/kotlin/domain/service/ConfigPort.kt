...
interface ConfigPort {
     ...
     *
     * @return [AppConfig] с заполненными [LlmConfig][io.averkhogliad.ai.challenge.week1.domain.config.LlmConfig]
     *         и [TaskExecutionConfig][io.averkhogliad.ai.challenge.week1.domain.config.TaskExecutionConfig]
