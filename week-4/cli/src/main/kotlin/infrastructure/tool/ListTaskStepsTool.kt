...
import io.averkhogliad.ai.challenge.week4.cli.application.service.TaskStepService
...
private fun List<TaskStep>.toJson(task: io.averkhogliad.ai.challenge.week4.cli.domain.model.Task): String =
    buildString {
        appendLine("{")
